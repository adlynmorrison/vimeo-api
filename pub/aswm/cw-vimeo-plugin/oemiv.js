/*
To allow outside scripts to access pieces of the sandbox, we need
...
var Oemiv = (function($) {
    ...
    /*
    To help visualize which parts of the sandbox are visible to the
    ...
    It's just a technique that I find helpful.

    The variables below are available only to the sandbox. The outside
